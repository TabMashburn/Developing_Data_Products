...
testing <- myTesting[clean2]          # allow only variables in testing that are also in myTraining
dim(myTesting)
```
...
cmtree<- confusionMatrix(predictionsA1, as.factor(myTesting$classe))
cmtree
```
...
```{r}
set.seed(12345)
modFitB1 <- randomForest(classe ~ ., data=myTraining,na.action=na.roughfix)
